 ...
 *
 * This function returns the closest multiple of the page size that is greater than or equal to the
 * given size. This is important to ensure that sufficient memory is allocated for the requested
 * size and also to comply with the requirements of the mmap system call: From the man page of mmap:
 ...
 * has a single '1' bit at position N, with all lower bits set to '0' (these represent the offset
 * within a page).
 *
 ...
 * @return The normalized size, which is the closest multiple of the page size that is greater than
